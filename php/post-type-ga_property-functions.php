...
function gmuw_websitesgmu_ga_property_admin_link($post_id) {
	...
	// build link
	$return_value.='<a href="'.gmuw_websitesgmu_ga_property_admin_link_url($post_id).'" target="_blank"><img class="gmuw_websitesgmu_offsitelink gmuw_websitesgmu_ga_property_link" style="width:25px; vertical-align: middle; margin-bottom:1px;" src="'.plugin_dir_url( __DIR__ ).'images/logo-google_analytics.png'.'" /></a><br />';
